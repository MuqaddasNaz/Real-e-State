...
class BookHostelActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityBookHostelBinding // Declare binding object


    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBookHostelBinding.inflate(layoutInflater) // Initialise binding object
