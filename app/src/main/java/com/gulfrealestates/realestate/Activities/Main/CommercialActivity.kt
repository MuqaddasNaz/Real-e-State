...
class CommercialActivity : AppCompatActivity(), CommercialAdapter.CommercialAdapterListener {

    private lateinit var recyclerView: RecyclerView
    private lateinit var swHome: SwipeRefreshLayout
    private lateinit var sh: SharedPref
    private lateinit var mContext: Context
    private lateinit var adapter: CommercialAdapter

    private lateinit var binding: ActivityCommercialBinding // Declare binding object
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCommercialBinding.inflate(layoutInflater) // Initialise binding object
        ...
        recyclerView = findViewById(R.id.rv_commercial)
        swHome = findViewById(R.id.sw_home)

        recyclerView.layoutManager = LinearLayoutManager(mContext)

        val adapter = CommercialAdapter(mContext, propertyList, this)
    ...
    private fun performSearch(query: String) {
        ...
        adapter = CommercialAdapter(mContext, filterList, this)
        recyclerView.adapter = adapter
        recyclerView.adapter?.notifyDataSetChanged()
    }
